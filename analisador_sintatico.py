...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("3. Exemplo inserido no código.")
        print("0. Sair")
        print("="*30)
        ...
        if escolha == '1':
            ...
            processar_codigo(codigo_exemplo, "Exemplo inserido no código")
            
        elif escolha == '0':
            print("\nA encerrar o analisador. Bom trabalho and Thank you, Come again!!!")
            break
